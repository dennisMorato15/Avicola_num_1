    ...
    <div class="col col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
        ...
        <div class="col ms-4 text-center">
            <div class="row">
                ...
                <button class="btn btn-dark text-center" data-bs-toggle="modal" data-bs-target="#galpon<?php echo $fila['idInventario']; ?>"><i class="bi bi-pencil-fill"></i>Ver mas</button>
                <?php
                    echo '    
                        </td></tr>';
