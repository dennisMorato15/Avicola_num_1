...
<head>
    <title>Avicola</title>
        <meta charset="utf-8">
        <meta name="descripcion" content="La finca avicola">
    ...
    ?>
            <div class="row">
                <h1 class="mt-3 mb-3"><b>Nueva Venta</b></h1>
                <?php
                    if($resultset->num_rows>0){
                        while($fila = $resultset->fetch_assoc()){
                        echo '<div class="card card-sm me-3 mt-3" style="width:18rem;">
                        <img src=".././img/'.$fila['imagen'].'" style = "width:100%; height:200px;" class="m-0 p-0 mt-2" alt="La imagen de huevos">
                        <div class="card-body">
                        <p class="card-title" style="font-size:22px;">'.$fila['nombreProducto'].'</p>
                        <class="card-text" style="font-size:22px;" >Precio: '.$fila['precioProducto'].'</p>'
                        ?>
